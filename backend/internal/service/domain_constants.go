...
const (
	...
	// SettingKeyOpenAICodexTicketPersonalEnabled 个人号打票细分开关；总开关开启时，
	// 个人号（free/plus/pro）是否参与打票与门控。缺失视为 true（兼容历史行为）。
	SettingKeyOpenAICodexTicketPersonalEnabled = "openai_codex_ticket_personal_enabled"
